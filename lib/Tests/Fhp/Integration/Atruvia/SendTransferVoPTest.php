...
class SendTransferVoPTest extends AtruviaIntegrationTestBase
{
     ...
     * @throws \Throwable
     */
    public function testVopWithResultMatch(): void
    {
        $this->initDialog();
        ...
        // a match, so the bank already went ahead and executed the transfer without asking for 2FA.
    ...
    private static function buildVopReportResponse(
