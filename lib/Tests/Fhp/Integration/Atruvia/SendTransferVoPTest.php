...
class SendTransferVoPTest extends AtruviaIntegrationTestBase
{
    ...
    public function test()
    {
        ...
        while ($transferAction->needsTime()) {
            ...
            $this->expectMessage(static::REQUEST_VOP_REPORT_REQUEST, str_replace('UTF8XMLPAYLOAD', self::REQUEST_VOP_REPORT_RESPONSE_XML_PAYLOAD, mb_convert_encoding(static::REQUEST_VOP_REPORT_RESPONSE, 'ISO-8859-1', 'UTF-8')));
