...
class InitDialogWithBlockedPinTest extends IngDibaIntegrationTestBase
{
    ...
    const SYNC_RESPONSE = "HNHBK:1:3+000000000239+300+FAKEDIALOGIDabcdefghijklmnopqr+1+FAKEDIALOGIDabcdefghijklmnopqr:1'HIRMG:2:2:+9800::Der Dialog wurde abgebrochen.+9942::Log-in fehlgeschlagen. 3 Fehlversuche fuhren zur Sperrung. Entsperren auf ING.de'HNHBS:3:1+1'";
