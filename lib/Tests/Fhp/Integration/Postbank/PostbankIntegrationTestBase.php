...
class PostbankIntegrationTestBase extends FinTsTestCase
{
    ...
    const SYNC_REQUEST = "HNHBK:1:3+000000000436+300+0+1'HNVSK:998:3+PIN:2+998+1+1::0+1:20190102:030405+2:2:13:@8@00000000:5:1+280:20010020:<PRIVATE__>:V:0:0+0'HNVSD:999:1+@272@HNSHK:2:4+PIN:2+930+9999999+1+1+1::0+1+1:20190102:030405+1:999:1+6:10:19+280:20010020:<PRIVATE__>:S:0:0'HKIDN:3:2+280:20010020+<PRIVATE__>+0+1'HKVVB:4:3+13+0+0+123456789ABCDEF0123456789+1.0'HKTAN:5:6+4+HKIDN+++++++++mT?:<PRIVATE>'HKSYN:6:3+0'HNSHA:7:2+9999999++<PRIVATE_>''HNHBS:8:1+1'";
    const SYNC_RESPONSE = "HNHBK:1:3+000000001258+300+FAKEDIALOGIDabcdefghijklmnopqr+1+FAKEDIALOGIDabcdefghijklmnopqr:1'HNVSK:998:3+PIN:1+998+1+2::FAKEKUNDENSYSTEMIDabcdefghijkl+1:20190102:030405+2:2:13:@8@\x00\x00\x00\x00\x00\x00\x00\x00:5:1+280:20010020:<PRIVATE__>:V:0:0+0'HNVSD:999:1+@1001@HIRMG:2:2+0020::Dialoginitialisierung erfolgreich.+3076::Keine starke Authentifizierung erforderlich.+3060::Teilweise liegen Warnungen/Hinweise vor.'HIRMS:3:2:3+0020::Information fehlerfrei entgegengenommen.'HIRMS:4:2:4+3920::Meldung unterstützter Ein- und Zwei-Schritt-Verfahren:912:913:920:930+1050::UPD nicht mehr aktuell. Aktuelle Version folgt.'HIRMS:5:2:6+0020::Auftrag ausgeführt.'HIUPA:6:4:4+<PRIVATE__>+28+0+<PRIVATE_______>'HIUPD:7:6:4+606744206::280:20010020+<PRIVATE_____________>+<PRIVATE__>+1+EUR+<PRIVATE________________>++PB Business Giro++HKSPA:1+DKTSP:1+HKTSP:1+DKPAE:1+HKPAE:1+HKPRO:1+HKTAB:1+HKTAN:1+DKPSA:1+HKPSA:1+HKCCS:1+HKCSE:1+HKCSB:1+HKCSL:1+HKCDE:1+HKCDB:1+HKCDL:1+HKSAL:1+HKKAZ:1+HKEKA:1+HKKAU:1+HKCDN:1+HKCCM:1+HKCME:1+HKCMB:1+HKCML:1+HKDME:1+HKBME:1+HKDSC:1+HKDMC:1'HIUPD:8:6:4+++<PRIVATE__>+++<PRIVATE_______>++++HKSPA:1+DKTSP:1+HKTSP:1+DKPAE:1+HKPAE:1+HKPRO:1+HKTAB:1+HKTAN:1+DKPSA:1+HKPSA:1'HISYN:9:4:6+FAKEKUNDENSYSTEMIDabcdefghijkl'HITAN:10:6:5+4++noref+nochallenge''HNHBS:11:1+1'";

    const SYNC_END_REQUEST = "HNHBK:1:3+000000000426+300+FAKEDIALOGIDabcdefghijklmnopqr+2'HNVSK:998:3+PIN:2+998+1+1::FAKEKUNDENSYSTEMIDabcdefghijkl+1:20190102:030405+2:2:13:@8@00000000:5:1+280:20010020:<PRIVATE__>:V:0:0+0'HNVSD:999:1+@204@HNSHK:2:4+PIN:2+930+9999999+1+1+1::FAKEKUNDENSYSTEMIDabcdefghijkl+1+1:20190102:030405+1:999:1+6:10:19+280:20010020:<PRIVATE__>:S:0:0'HKEND:3:1+FAKEDIALOGIDabcdefghijklmnopqr'HNSHA:4:2+9999999++<PRIVATE_>''HNHBS:5:1+2'";
