...
class GetStatementOfAccountTest extends DKBIntegrationTestBase
{
    ...
    const HIKAZ_CONTENT = '@611@' . self::MT940_STATEMENT_1 . self::MT940_STATEMENT_2 . "'";
    ...
    {
        $this->initDialog();
        $this->expectMessage(static::GET_STATEMENT_REQUEST, static::GET_STATEMENT_PAGE_1_RESPONSE);
        $this->expectMessage(static::GET_STATEMENT_PAGE_2_REQUEST, static::GET_STATEMENT_PAGE_2_RESPONSE);
        $getStatement = $this->runInitialRequest();
        $this->assertFalse($getStatement->needsTan());
        $this->checkResult($getStatement->getStatement());
    }
