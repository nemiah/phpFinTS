...
/**
 * Retrieves statements in the MT 940 format (HKKAZ), which is what most banks supported historically. Note that MT 940
 * is being phased out in favor of CAMT XML (see {@link GetStatementOfAccountXML}), so unless you need the raw MT 940
 * data, you probably want to use {@link GetStatementOfAccount}, which picks whichever format the bank supports.
 */
class GetStatementOfAccountMT940 extends AbstractGetStatementOfAccount
{
     ...
     * @return GetStatementOfAccountMT940 A new action instance.
     */
    public static function create(SEPAAccount $account, ?\DateTime $from = null, ?\DateTime $to = null, bool $allAccounts = false, bool $includeUnbooked = false): GetStatementOfAccountMT940
    {
