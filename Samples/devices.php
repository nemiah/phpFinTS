...
class testLogger extends Psr\Log\AbstractLogger {
	...
	public function log($level, $message, array $context = array()): void {
		file_put_contents(__DIR__."/devices.log", file_get_contents(__DIR__."/devices.log").$message."\n");
	}

}

file_put_contents(__DIR__."/devices.log", "");
...
$fints->setTANMechanism(921, ''); //DKB
// $fints->setTANMechanism(912, 'A'); //Postbank

print_r($fints->getTANDevices());
$fints->end();